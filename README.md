...
Correr en local (sin K8s)

Docker Compose (opcional)

Kubernetes en local con Minikube

Manifests

Ruta A: usando Docker Hub

Ruta-b-sin-registro-usando-la-imagen-local

Configurar contra AWS RDS (producción)
